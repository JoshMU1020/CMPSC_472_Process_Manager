...
Going into this project, to be honest, I felt very overwhelmed. While the concepts in isolation were familiar to me, the idea of stringing them together into an actual single system felt daunting. Especially due to my training in class relatively often relying on conceptual representations of processes and data, when I began the design of this software, I essentially had no idea where to even begin. It was through a fair amount of searching, through Python libraries and coding examples, that I was able to scrounge together some semblance of how to go about stringing as many of these concepts together as I could manage. That said, I still ended up relying on some conceptual representations of data and processes to implement some of the requirements in a qhat that would somewhat showcase the ability for those requirements to be displayed in this Python process manager software. In the end, I suppose I was able to implement a more complete product than I initially thought I would have been able to, even though the end product still leaves much to be desired. It was also interesting to try and find solutions to the development environment-related issues that I previously mentioned, as I had not had much of an excuse to experiment with the Linux OS or terminal until I used them to develop this software. While I know my level of success in this project's endeavor was sparse, I still feel as though I was able to gain some good experience related to operating systems and process management overall.
